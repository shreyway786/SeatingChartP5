...
public class AnitAnnadi extends Student implements SpecialInterestOrHobby
{
    ...
    /**
     * Constructor for the Anit class.
     ...
     * 
     */
    public AnitAnnadi(String f, String l, int r, int s) {
        firstName=f;
        lastName=l;
        mySeatX=r;
        mySeatY=s;
    ...
    public AnitAnnadi() {
     ...
     /**
     * Act - do whatever the Anit actor wants to do. This method is called whenever
