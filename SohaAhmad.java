...
public class SohaAhmad extends Student
{
        ...
        if(Greenfoot.mouseClicked(this)){
          //  if (sitting){
            ...
            // Call the sitDown() method to move back  to your seat
                ...
                getWorld().addObject(new ghost1(), 7, 1);
                fight();
                //allowmove();
                sitDown();
            }
    ...
    public void fight(){
        ...
        getWorld().addObject(new transparent(), 7, 1);
        // move back
        for (int i=1;i<=5;i++){
            setLocation(7,i);
            Greenfoot.delay(10);
        ...
        for (int i=7;i>=5;i--){
            ...
            // (4,5)
            if (i==6) {
                getWorld().addObject(new ghost1(), 10, 5);
            }
        }  
        // move right
        for (int i=4;i<=10;i++){
            ...
            // (10,5)
            if (i==7) {
                getWorld().addObject(new ghost1(), 1, 5);
            }
        }  
        getWorld().addObject(new transparent(), 10, 5);
        // move back
        for (int i=5;i<=8;i++){
            setLocation(10,i);
            Greenfoot.delay(10);
        ...
        getWorld().addObject(new transparent(), 1, 5);
        // move back
        for (int i=5;i<=8;i++){
            setLocation(1,i);
            Greenfoot.delay(10);
