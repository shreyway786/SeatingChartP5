...
public class Classroom extends World
{
 ...
 // and then clicking on the inspect text
        ...
        VihaanKhajanchi vihaankhajanchi = new VihaanKhajanchi();
        addObject(vihaankhajanchi,6,4);
        vihaankhajanchi.assignSeat();
        ...
        ThaneeshBedadham thaneeshbedadham = new ThaneeshBedadham();
        addObject(thaneeshbedadham,9,3);
        thaneeshbedadham.assignSeat();
        ...
        RyanChakma ryanchakma = new RyanChakma();
        addObject(ryanchakma,8,3);
        ...
        addObject(samarthpasala,2,7);
        samarthpasala.assignSeat();
